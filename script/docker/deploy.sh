...
#启动监控模块
monitor(){
    docker-compose up -d sxpcwlkj-monitor-admin
}

#启动程序模块
start(){
    docker-compose up -d sxpcwlkj-xxl-job-admin sxpcwlkj-server1 sxpcwlkj-server2
}

#停止程序模块
stop(){
    docker-compose stop sxpcwlkj-xxl-job-admin sxpcwlkj-server1 sxpcwlkj-server2
}
